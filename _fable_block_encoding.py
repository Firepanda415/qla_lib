...
###################
## from _util.py in https://github.com/QuantumComputingLab/fable/tree/main/py/fable
    ...
    while i < a.shape[0]:
        ...
        for j in range(1, 2*n+1):
            if parity_check & (1 << (j-1)):
                circ.cx(j, 0) ## Muqing: update for Qiskit 1.2
...
##################
## from fable.py in https://github.com/QuantumComputingLab/fable/tree/main/py/fable
